...
| T04 | Meridian Data Co. | Market Research / SaaS | Pilot | Replace ad-hoc `psutil` scripts with structured memory events and background checks | CLI + Pytest conftest + Background checks | 2026-04-07 | 2026-05-10 | Pilot validation complete: 38% drop in flaky memory-related CI reruns over 3 weeks | Execute production readiness review; lock rollout plan for next release train |
